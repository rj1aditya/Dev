...
A: Sure! Here is a simple addition program in Python:

```python

Q: What is the capital of India?
A: I am sorry, I can only answer coding questions.
"""
response = client.chat.completions.create(
    model="gpt-4o-mini",
    messages = [
        {"role": "system", "content": SYSTEM_PROMPT},
        {"role": "user", "content": "Hey there! write me a esaay in science."}
    ]
)
