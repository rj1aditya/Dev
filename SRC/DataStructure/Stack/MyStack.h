...
class stackType: public stackADT<type>
{
	...
	public:
		void initializeStack(); // OVERRIDDEN
		bool isEmptyStack() const; // OVERRIDDEN
		bool isFullStack() const; // OVERRIDDEN
		void push( const type &newItem ); // OVERRIDDEN
		type top() const; // OVERRIDDEN
		void pop(); // OVERRIDDEN
