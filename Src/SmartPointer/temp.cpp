...
int main()
{
  ...
  std::pair<MoveClass, CopyClass> my_pair{ MoveClass{ 13 }, CopyClass{} };
  ...
  try
  {
    ...
    //std::pair<MoveClass, CopyClass> moved_pair{ std::move(my_pair) }; // We'll comment out this line later
    std::pair<MoveClass, CopyClass> moved_pair{std::move_if_noexcept(my_pair)}; // We'll uncomment this line later
